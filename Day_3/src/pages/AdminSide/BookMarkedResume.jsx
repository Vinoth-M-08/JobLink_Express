                    ...
                    <div class="collapse" id="MobNav">
                       <div class="dashboard-nav">
                           ...
                           <ul data-submenu-title="Main Navigation">
								...
								<li  class="active"><Link to="/BookMarkedResume">BookMarked Resumes</Link></li>
                       ...
                       <div class="dashboard-tlbar d-block mb-5">
                           <div class="row">
                               <div class="colxl-12 col-lg-12 col-md-12">
                                   <h1 class="ft-medium">Book Resumes</h1>
                                       ...
                                       <div class="flixors">
                                           <div class="row align-items-center justify-content-between">
                                               <div class="col-xl-3 col-lg-4 col-md-5 col-sm-12">
                                                   <h6 class="mb-0 ft-medium fs-sm">0 Resumes</h6>
                                               </div>
                                               ...
                                               <div class="dashed-list-short d-flex align-items-center">
                                                   ...
                                                   <div class="dashed-list-short-last">
                                                       <div class="cats-box-caption px-2">
                                                           <h4 class="fs-lg mb-0 ft-medium theme-cl">SriHari KR</h4>
                                                            <p>Hari@gmail.com</p>
                                                           <div class="d-block mb-2 position-relative">
                                                               ...
                                                               <FaLocationDot />&nbsp;
                                                                   Erode</span>
                                                                   &nbsp;&nbsp;
                                                               <span class="ms-2"><FaBriefcase />&nbsp;Full Stack Developer</span>&nbsp;
...
export default BookMarkedResume;